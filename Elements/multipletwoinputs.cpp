...
class MultipleTwoInputsWidget: public QGraphicsWidget
{
    qreal width, height;
    LDElement &el;
public:
    MultipleTwoInputsWidget(qreal width, qreal height,  LDElement &el, QGraphicsItem *parent=nullptr): QGraphicsWidget(parent),width(width),height(height), el(el)
    {
...
public:
    ...
    void paint(QPainter *painter, const QStyleOptionGraphicsItem *option, QWidget *widget) override
    {
        ...
        QSvgRenderer renderer(QString(":/images/multiple_two.svg"),this);
...
MultipleTwoInputs::MultipleTwoInputs(qreal cell_width, qreal cell_height):LDElement (cell_width,cell_height)
{
    item = new MultipleTwoInputsWidget(cell_width,cell_height,*this);
    item->setToolTip("Умножение");
    row_span = 2;
    input_count=2;
    setType("multiple two inputs");
}

LDElement *MultipleTwoInputs::clone()
{
    auto* el = new MultipleTwoInputs(cell_width,cell_height);
